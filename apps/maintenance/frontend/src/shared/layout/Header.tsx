...
import { Bell, AlertTriangle, Clock, Calendar, LogOut } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          >
            ...
            {alertCount > 0 && (
              <span className="absolute -top-1 -right-1 h-5 w-5 rounded-full bg-red-500 text-[10px] font-black text-white flex items-center justify-center border border-white dark:border-slate-950 shadow-md">
                {alertCount}
              </span>
            )}
          </button>
                  ...
                  {mockNotifications.map((notif) => (
                    ...
                    >
                      {notif.type === "overdue" ? (
                        ...
                        <Calendar className="h-4 w-4 text-cyan-600 dark:text-cyan-400 shrink-0 mt-0.5" />
                      )}
