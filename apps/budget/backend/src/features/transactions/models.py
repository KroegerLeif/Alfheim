...
class TransactionBase(SQLModel):
    ...
    account_id: UUID | None = Field(default=None, foreign_key="accounts.id", index=True, ondelete="RESTRICT")
    pot_id: UUID | None = Field(default=None, foreign_key="pots.id", index=True, ondelete="RESTRICT")
