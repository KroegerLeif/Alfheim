...
describe('useTranslation Hook', () => {
  ...
  it('defaults to German language and translates common and budget keys', () => {
    ...
    expect(result.current.t('auth.securing_session')).toBe('Sitzung mit Zitadel wird gesichert...')
  ...
  it('translates keys in English when language is set to en', () => {
    ...
    expect(result.current.t('auth.securing_session')).toBe('Securing session with Zitadel...')
  ...
  it('translates keys in Polish when language is set to pl', () => {
    ...
    expect(result.current.t('auth.securing_session')).toBe('Zabezpieczanie sesji z Zitadel...')
